...
<style lang="scss" scoped>
  ...
  @include wh(100 %, 1.4 rem);
  }

  .city_input {
    border: 1px solid $ bc;
    padding: 0 0.3rem;
  @include sc(0.65 rem, #333);
  }

  .city_submit {
    background-color: $ blue;
  @include sc(0.65 rem, #fff);
  }
  ...
  .pois_search_history {
    ...
    border-bottom: 1px solid $ bc;
    padding-left: 0.5rem;
  @include font(0.475 rem, 0.8 rem);
  }
  ...
  .search_none_place {
    margin: 0 auto;
  @include font(0.65 rem, 1.75 rem);
    color: #333;
    background-color: #fff;
    text-indent: 0.5rem;
  }
