...
<style lang="scss" scoped>
  ...
  .sa-body {
  @include wh(5 px, 47 px);
  @include borderRadius(2 px);
    background: #f8bb86;
  @include cl;
    top: 10px;
  }
