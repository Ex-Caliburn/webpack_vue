  ...
  export default {
    ...
    methods: {
      ...
      async changeTgeIndex(index, name){
        ...
        let res = await
          getRatingList(this.shopId, this.ratingOffset, name);
        this.ratingList = [.
          ..res
      ]
        ;
      ...
      async loaderMoreRating(){
        ...
        let ratingDate = await
          getRatingList(this.shopId, this.ratingOffset, this.ratingTagName);
        this.ratingList = [.
          ..this.ratingList,
      ...
        ratingDate
...
<style lang="scss" scoped>
  ...
  span:nth-of-type(1) {
  @include sc(.5 rem, #f60);
    margin-right: .05rem;
  }

  span:nth-of-type(2) {
  @include sc(.7 rem, #f60);
    font-weight: bold;
    margin-right: .3rem;
  }

  span:nth-of-type(3) {
  @include sc(.5 rem, #666);
  }
  ...
  .time_spent_desc {
  @include sc(.55 rem, #666) margin-left: .15 rem;
  }
